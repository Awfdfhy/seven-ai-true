...
has('am start -W -n ${ACTIVITY} --splashscreen-show-icon');
...
console.log(`Android Splash Burst Contract: PASS (${n} assertions; exact release APK + real adb frame burst + branded transient-state discrimination)`);
