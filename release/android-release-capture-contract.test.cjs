...
console.log(`Android Release Capture Contract: PASS (${n} assertions; app-scoped test assembly, release evidence stays fail-closed, Reduced Motion cannot be forged)`);
