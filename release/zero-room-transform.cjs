...
function transformFile(file){const before=fs.readFileSync(file,'utf8');const after=applyZeroRoomTransform(before);fs.writeFileSync(file,after);return after;}
...
module.exports={applyZeroRoomTransform,transformFile};
