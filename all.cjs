...
const releaseTests=[path.join('release','contrast.test.cjs'),path.join('release','static-audit.cjs'),path.join('release','canon-simulator.test.cjs'),path.join('release','world-runtime.test.cjs'),path.join('release','release-verify.cjs')];
