...
fs.writeFileSync(path.join(WWW,'seven-packaging.json'),JSON.stringify({format:'seven-android-web-payload',version:3,lazyWorkspaces:true,adaptiveBrand:true},null,2));
