const CACHE='seven-design-studio-v6';
const LOCAL=['./','./index.html','./studio.css','./studio-bridge.js','./studio.js','./home-2026.js','./home-reference-v2.js','./mobile-polish.css','./mobile-polish.js','./manifest.webmanifest','./seven-design-icon.svg'];
const REMOTE=[
