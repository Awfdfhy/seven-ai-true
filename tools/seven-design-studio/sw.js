const CACHE='seven-design-studio-v5';
const LOCAL=['./','./index.html','./studio.css','./studio-bridge.js','./studio.js','./home-2026.js','./mobile-polish.css','./mobile-polish.js','./manifest.webmanifest','./seven-design-icon.svg'];
const REMOTE=[
  'https://unpkg.com/grapesjs@0.23.6/dist/grapes.min.css',
