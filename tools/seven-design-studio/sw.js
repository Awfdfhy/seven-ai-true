const CACHE='seven-design-studio-v8';
const LOCAL=['./','./index.html','./studio.css','./studio-bridge.js','./studio.js','./home-synthesis-v3.js','./mobile-polish.css','./mobile-polish.js','./manifest.webmanifest','./seven-design-icon.svg'];
const REMOTE=[
