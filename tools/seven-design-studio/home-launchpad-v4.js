...
@media(max-width:345px){.seven-home-v4{padding-inline:12px}.v4-intro{grid-template-columns:1fr}.v4-ready{justify-self:start}.v4-intro h1{font-size:27px}.v4-context span{display:none}.v4-context{width:48px;padding:0;justify-content:center}.v4-input-hint{display:none}.v4-shortcuts{gap:6px}.v4-shortcut{height:62px;border-radius:16px}.v4-bottom-nav{left:8px;right:8px}.v4-bottom-nav small{font-size:10px}.v4-wordmark{letter-spacing:.22em}.v4-live{display:none}}
